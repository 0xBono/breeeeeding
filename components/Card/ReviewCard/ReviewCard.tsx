        ...
        <div className={cx('reviewcard-content')}>
          ...
          <div className={cx('reviewcard-cotent-inner')}>
            ...
            <span className={cx('reviwer-content')}>
              ...
              있어요 단독 주택에 사는 게 아니다보니 사람이 집에 왔을 때 짖는 걸 줄이고 싶어 교육을 받게 되었습니다.별
              100개 주고 싶을 만큼 만족! 우리집 아가가 집 앞에 사람
            </span>
          </div>
        </div>
        <img className={cx('thumbnail')} src="assets/temp_img.svg" alt="profile" />
      </div>
    </div>
  );
};
